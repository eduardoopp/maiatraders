const SinglePage = () => {
    return (
        <div className="flex flex-col items-center h-screen text-white">
            ...
            <div>
                <img src="public/carlinhos.jpg" alt="money" className="w-60 h-75 rounded-3xl mt-5" />
            </div>
            <div className="flex gap-2 mt-5">
                <p>
                    Comunidade no TELEGRAM
                </p>
                <img src="public/telegram.png" className="w-5 h-5" />
            </div>
            ...
            <div className="mt-7 flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                    <img src="public/trophy.png" className="w-5 h-5" />
                    <p>Operanções 100% AO VIVO</p>
                </div>


                <div className="flex gap-2">
                    <img src="public/coin.png" className="w-5 h-5" />
